## ©copyright infringement on Dewill's Team
...
➠ ʀᴜɴɴɪɴɢ ᴏɴ Private sᴇʀᴠᴇʀ. 
➠ ᴘʀᴏᴠɪᴅᴇᴅ ᴠɪᴅᴇᴏ sᴜᴘᴘᴏʀᴛ. 
➠ ᴘᴏᴡᴇʀᴇᴅ ʙʏ [Dewill's Music](https://t.me/DewillsMusic) 
...
async def commands_set(_, query: CallbackQuery):
    await query.edit_message_text(
        f"""💗 ʜᴇʟʟᴏ [{query.message.chat.first_name}](tg://user?id={query.message.chat.id}) 
➠ ʜᴇʟʟᴏ ɴᴀᴍsᴛʜᴇ ᴛʜɪs ɪs ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ɢᴜɪᴅᴇ ᴡʜᴀᴛ ᴄᴏᴍᴍᴀɴᴅ ʏᴏᴜ ɴᴇᴅᴅ sᴇʟᴇᴄᴛ ʜᴇʀᴇ.. 

➠ ᴛʜɪs ʙᴏᴛ ᴍᴀᴅᴇ ᴀɴᴅ ᴅᴇᴠᴇʟᴏᴘᴇᴅ ʙʏ [Dewill's Music](https://t.me/DewillsMusic) 
""", 
    reply_markup=InlineKeyboardMarkup( [[
...
➠ **ᴅᴇsɪɢɴᴇᴅ ᴀɴᴅ ᴅᴇᴠᴇʟᴏᴘᴇᴅ ʙʏ [Dewill's Music](https://t.me/DewillsMusic)**""", 
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
...
➠  **ᴛʜɪs ɪs ᴛʜᴇ Dewill's Music sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ғᴏʀᴋ ᴀɴᴅ ɢɪᴠᴇ ᴀ ⭐ sᴛᴀʀᴛ ᴛᴏ ʀᴇᴘᴏ""", 
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("sᴏᴜʀᴄᴇ", url="https://github.com/Minni-Snigdha/DewillsMusic")]]
        ),
    ) 
...
➠ Dewill's Music ɪs ᴀ ʙᴏᴛ ᴅᴇᴠᴇʟᴏᴘᴇᴅ ɪɴ sᴏ ᴍᴀɴʏ sᴇʀᴠᴇʀ's, ɪᴛ's ᴏɴʟɪɴᴇ sɪɴᴄᴇ 27th September 𝟸𝟶𝟸𝟸 ᴀɴᴅ ɪᴛ's ᴄᴏɴsᴛᴀɴᴛʟʏ ᴜᴘᴅᴀᴛᴇᴅ \n
➠ ᴛʜɪs ʙᴏᴛ ᴅᴇᴠᴇʟᴏᴘᴇᴅ ʙʏ [Dewill's MUsic](https://t.me/DewillsMusic) \n 
➠ © ᴏɴ ʙᴇʜᴀʟғ ᴏғ [Moana](https://t.me/MoanaSupport)
""", 
        reply_markup=InlineKeyboardMarkup(
