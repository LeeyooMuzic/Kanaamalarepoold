        ...
        if round(audio.duration / 60) > DURATION_LIMIT:
            ...
            [
                ...
                await m.reply_photo(
                    ...
                    caption=f"**🍀ɴᴇxᴛ sᴏɴɢ ᴀᴛ ᴘᴏsɪᴛɪᴏɴ ɪɴ Dewill's sᴇʀᴠᴇʀ... `{pos}` 🌷 ...**",
                )
            else:
            ...
            [
                ...
                await m.reply_photo(
                    photo=image,
                    reply_markup=buttons,
                    caption=f"**🍃Dewill's Music ᴠɪᴅᴇᴏ ᴘʟᴀʏɪɴɢ ᴏɴ Dewill's ᴘʀɪᴠᴀᴛᴇ sᴇʀᴠᴇʀ ...**",
                )
        else:
            if len(m.command) < 2:
                await m.reply(
            ...
            [
                [
                    ...
                    await m.reply_photo(
                        photo=f"{IMG_2}",
                        reply_markup=buttons,
                        caption=f"**🔥Dewill's Music ɴᴏᴡ sᴛʀᴇᴀᴍɪɴɢ ᴏɴ Dewill's ᴘʀɪᴠᴀᴛᴇ sᴇʀᴠᴇʀ 🍃**",
                    )
                except Exception as ep:
                    await loser.delete()
                    await m.reply_text(f"🚫 ᴇʀʀᴏʀ: `{ep}`")
